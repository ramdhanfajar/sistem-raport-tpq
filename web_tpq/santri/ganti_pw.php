...
// Ambil nama santri dari session
$nama_santri = $_SESSION['nama_lengkap'] ?? "Santri"; 
$status_msg = '';
...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    header("Location: ganti_password_santri.php?status=" . $status_msg);
    exit();
}
...
<head>
    ...
    <style>
        /* (Salin CSS dari ganti_password.php pengajar) */
        :root {
            --warna-hijau: #00a86b;
