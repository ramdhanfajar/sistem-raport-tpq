...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    // Redirect kembali ke halaman ini dengan status
...
<head>
    ...
    <style>
        ...
        *, *:before, *:after { box-sizing: inherit; }
        ...
        .card-form {
            max-width: 500px;
            /* Pusatkan kartu di tengah halaman (untuk desktop) */
            margin: 0 auto; 
            background-color: #E0E0E0; /* Latar abu-abu muda */
            border-radius: 20px;
        ...
        .form-group input {
            width: 100%;
            padding: 12px 45px 12px 20px; /* Jarak untuk ikon */
            font-family: 'Poppins', sans-serif;
            font-size: 1rem;
            border: none;
            border-radius: 30px;
            background-color: #AFF0D1; /* Warna hijau mint */
            color: var(--warna-teks-abu);
        ...
        .btn-batal {
            background-color: #D6D6D6; /* Abu-abu */
            color: var(--warna-teks-abu);
        }
        .btn-batal:hover {
        ...
        .btn-update {
            background-color: #84E0B3; /* Hijau muda */
            color: var(--warna-teks-abu);
        }
        .btn-update:hover {
    ...
    <script>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            if (status === 'sukses') {
                Swal.fire({
                    title: 'Berhasil!',
                    text: 'Password Anda telah diubah.', // Persis seperti gambar Anda
                    icon: 'success',
                    confirmButtonText: 'Ok', // Persis seperti gambar
