...
<head>
    ...
    <style>
        ...
        *, *:before, *:after { box-sizing: inherit; }
        ...
        .data-table td:nth-child(4) { /* Kolom Nilai */
            font-weight: 700;
            color: var(--warna-hijau);
            font-size: 1rem;
            text-align: center;
        }
        .data-table td:last-child { /* Kolom Catatan */
            text-align: center;
        }
        .catatan-baik {
            color: var(--warna-hijau);
        ...
        .data-table tfoot td:nth-child(2) { /* Rata-rata Nilai */
            color: var(--warna-hijau);
            font-size: 1.1rem;
            text-align: center;
        }
         .data-table tfoot td:last-child { /* Rata-rata Catatan (Kosong) */
            text-align: center;
        }
        .no-data {
            text-align: center;
...
<body>
                    ...
                    <table class="data-table">
                        ...
                        <tbody>
                            <?php if (empty($data_nilai)): ?>
                                <tr>
                                    <td colspan="5" class="no-data"> <?php if(empty($list_tahun_ajaran)): ?>
                            ...
                            <?php else: ?>
                                <?php foreach ($data_nilai as $nilai): ?>
                                    <?php 
                                        // Logika sederhana untuk Catatan (bisa disesuaikan)
                                        $catatan_nilai = (int) $nilai['nilai'];
                                        if ($catatan_nilai >= 75) {
                                            $catatan_teks = "Baik";
                                            $catatan_class = "catatan-baik";
                                        } else {
                                            $catatan_teks = "Perlu Peningkatan";
                                            $catatan_class = "catatan-kurang";
                                        }
                                    ?>
                                    <tr>
                                        ...
                                        <td class="<?php echo $catatan_class; ?>">
                                            <?php echo $catatan_teks; ?>
                                        </td> </tr>
                                <?php endforeach; ?>
                            <?php endif; ?>
                        </tbody>
                        ...
                        <tfoot>
                            <tr>
                                ...
                                <td colspan="1"><strong><?php echo number_format($rata_rata, 2); ?></strong></td>
                                <td></td> </tr>
                        </tfoot>
                        <?php endif; ?>
                    </table>
    ...
    <script>
        ...
        // --- 2. JS Pop-up Selamat Datang (Dihapus dari sini karena tidak relevan) ---
