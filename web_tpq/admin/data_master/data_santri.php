                        ...
                        <tbody>
                            ...
                            <?php else: ?>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a href="../data_master/crud/edit_santri.php?id=<?php echo $santri['id']; ?>" class="btn-aksi btn-edit"><i class="fas fa-pencil-alt"></i> Edit</a>
                                        <a href="../data_master/crud/delete_santri.php?id=<?php echo $santri['id']; ?>" class="btn-aksi btn-hapus" onclick="return confirm('Apakah Anda yakin ingin menghapus santri ini?');"><i class="fas fa-trash-alt"></i> Hapus</a>
                                    </td>
                                </tr>
                                <?php endforeach; ?>
                            <?php endif; ?>
