...
<head>
    ...
    <style>
        ...
        *, *:before, *:after { box-sizing: inherit; }
        ...
        .data-table .no-data { text-align: center; padding: 30px; font-style: italic; color: #777; }
...
<body>
                ...
                <form method="POST" class="form-grid">
                    ...
                    <div class="form-group">
                        ...
                        <select name="id_kelas" id="id_kelas" required>
                            <option value="" data-tahun="">-- Pilih Kelas --</option>
                            <?php foreach($list_kelas as $k): ?>
                                <option value="<?php echo $k['id']; ?>" data-tahun="<?php echo htmlspecialchars($k['tahun_ajaran']); ?>">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="tahun_ajaran" id="tahun_ajaran" placeholder="Otomatis terisi" readonly style="background-color: #eee; cursor: not-allowed;">
                    </div>
                    
                    <div class="form-group">
                        <label>&nbsp;</label>
                        <button type="submit" name="tambah" class="btn-simpan"><i class="fas fa-plus"></i> Simpan</button>
                    </div>
                </form>
            </div>
                    ...
                    <table class="data-table">
                        ...
                        <tbody>
                            <?php if (empty($data_jadwal)): ?>
                                <tr><td colspan="6" class="no-data">Belum ada jadwal yang ditambahkan.</td></tr>
                            <?php else: ?>
    ...
    <script>
        ...
        // === LOGIKA BARU: AUTO-FILL TAHUN AJARAN ===
        ...
        selectKelas.addEventListener('change', function() {
            ...
            // Ambil nilai dari atribut data-tahun
            const tahun = selectedOption.getAttribute('data-tahun');
            // Isi ke input
            inputTahun.value = tahun ? tahun : '';
        });
    </script>
