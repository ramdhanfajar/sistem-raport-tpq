        ...
        <ul class="sidebar-nav">
            ...
            <li class="nav-item dropdown">
                ...
                <ul class="submenu">
                    ...
                    <li><a href="../laporan/daftar_nilai.php">Laporan Daftar Nilai</a></li>
                </ul>
            </li>
                        ...
                        <tbody>
                            ...
                            <?php else: ?>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a href="../data_master/crud/edit_guru.php?id=<?php echo $guru['id']; ?>" class="btn-aksi btn-edit"><i class="fas fa-pencil-alt"></i> Edit</a>
                                        <a href="../data_master/crud/delete_guru.php?id=<?php echo $guru['id']; ?>" class="btn-aksi btn-hapus" onclick="return confirm('Apakah Anda yakin ingin menghapus guru ini?');"><i class="fas fa-trash-alt"></i> Hapus</a>
                                    </td>
                                </tr>
                                <?php endforeach; ?>
                            <?php endif; ?>
