<?php
session_start();
// Pastikan path koneksi.php sudah benar, berdasarkan laporan_guru.php,
// asumsikan file ini berada di folder 'laporan' dan koneksi di root '..'
require '../../koneksi.php'; 
...
// --- 2. AMBIL DATA SANTRI UNTUK LAPORAN ---
$sql = "SELECT
            ds.id,
            ds.nis,
            ds.nama_lengkap,
...
<head>
    ...
    <title>Laporan Data Santri - Admin</title>
    
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.5.1/css/all.min.css">
    <link href="https://fonts.googleapis.com/css2?family=Poppins:wght@400;500;600;700&display=swap" rel="stylesheet">

    <style>
        /* CSS SAMA PERSIS DENGAN laporan_guru.php UNTUK KONSISTENSI TAMPILAN */
        :root {
            --warna-hijau: #00a86b;
        ...
        *, *:before, *:after { box-sizing: inherit; }
        ...
        @media print {
            ...
            .sidebar, .header, .card-header, .hamburger-btn, .user-profile { display: none !important; }
            ...
            .dashboard-area::before {
                content: "Laporan Data Santri - TPQ Daarul Hikmah";
                display: block;
                text-align: center;
                font-size: 1.5rem;
                font-weight: bold;
        ...
        <ul class="sidebar-nav">
            ...
            <li class="nav-item dropdown active">
                ...
                <ul class="submenu active">
                    ...
                    <li class="active-sub"><a href="laporan_santri.php">Laporan Daftar Santri</a></li>
                    <li><a href="laporan_nilai.php">Laporan Daftar Nilai</a></li>
                </ul>
            </li>
                        ...
                        <tbody>
                            ...
                            <?php else: ?>
                                ...
                                <tr>
                                    ...
                                    <td><?php echo htmlspecialchars($santri['email']); ?></td>
                                    <td><?php echo htmlspecialchars($santri['jenis_kelamin'] ?? '-'); ?></td>
