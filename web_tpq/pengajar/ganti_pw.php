...
$status_msg_php = ''; // Variabel untuk pesan status dari PHP

// --- 2. AMBIL DATA PENGGUNA (UNTUK HEADER) ---
$nama_pengajar = "Pengajar";
$file_foto_pengajar = null; // Variabel untuk foto

$stmt_profil = $koneksi->prepare("SELECT nama_lengkap, foto FROM data_pengajar WHERE user_id = ?");
...
if($result_profil->num_rows > 0) {
    ...
    $file_foto_pengajar = $data_profil['foto']; // Ambil foto
...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    // Redirect kembali ke halaman ini (ganti_password.php)
    header("Location: ganti_password.php?status=" . $status_msg_php);
    exit();
}
...
<body>
    ...
    <nav class="sidebar" id="sidebar">
        ...
        <ul class="sidebar-nav">
            ...
            <li class="active"><a href="ganti_password.php"><i class="fas fa-lock"></i> Ganti Password</a></li>
    ...
    <div class="main-content">
        ...
        <main class="dashboard-area">
            ...
            <div class="card-form">
                ...
                <form action="ganti_password.php" method="POST" id="change-password-form">
    ...
    <script>
        ...
        // --- 4. JS Pop-up Status (setelah redirect) ---
        document.addEventListener('DOMContentLoaded', function() {
            // Ambil status dari variabel PHP
            const status = "<?php echo $status_msg_php; ?>";
